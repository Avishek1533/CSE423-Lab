...
def drawEnemies():
    ...
    for enemy in enemies:
        ...
        glColor3f(0, 0.8, 0)  # Green color for the enemy's head
...
def update():
    ...
    global bullets, enemies, life_remaining, score, bullets_missed, time_elapsed, player_pos, player_angle, player_speed, player_rotate_speed, game_over, first_person_mode, camera_pos, cheat_mode, gun_follow_mode
...
def showScreen():
    ...
    wall_height = 100
    glBegin(GL_QUADS)
    glColor3f(0.5, 0.1, 0.9)  # Purple color / Top Wall
    glVertex3f(-GRID_LENGTH, -GRID_LENGTH, 0)
    glVertex3f(GRID_LENGTH, -GRID_LENGTH, 0)
    glVertex3f(GRID_LENGTH, -GRID_LENGTH, wall_height)
    glVertex3f(-GRID_LENGTH, -GRID_LENGTH, wall_height)

    glColor3f(0.1, 0.8, 0.5)  # Teal color / Left Wall
    glVertex3f(-GRID_LENGTH, GRID_LENGTH, 0)
    glVertex3f(-GRID_LENGTH, -GRID_LENGTH, 0)
    glVertex3f(-GRID_LENGTH, -GRID_LENGTH, wall_height)
    glVertex3f(-GRID_LENGTH, GRID_LENGTH, wall_height)

    glColor3f(0.9, 0.6, 0.1)  # Orange color / Bottom Wall
    glVertex3f(-GRID_LENGTH, GRID_LENGTH, 0)
    glVertex3f(GRID_LENGTH, GRID_LENGTH, 0)
    glVertex3f(GRID_LENGTH, GRID_LENGTH, wall_height)
    glVertex3f(-GRID_LENGTH, GRID_LENGTH, wall_height)  

    glColor3f(0.2, 0.7, 0.9)  # Light blue color / Right Wall
    glVertex3f(GRID_LENGTH, GRID_LENGTH, 0)
    glVertex3f(GRID_LENGTH, -GRID_LENGTH, 0)
    glVertex3f(GRID_LENGTH, -GRID_LENGTH, wall_height)
    glVertex3f(GRID_LENGTH, GRID_LENGTH, wall_height)
